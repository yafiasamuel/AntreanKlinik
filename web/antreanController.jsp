  ...
  <body>
    ...
    <form action="AntreanManager" method="post">
      <div class="ui buttons">
        <input type="submit" id="next" class="ui positive button" name="next" value="Next">
        <input type="submit" class="ui red button" id="skip" name="skip" value="Skip">
      </div>
    </form>
